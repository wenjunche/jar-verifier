...
/**
 * Example for verifying jar signed by jarsigner.exe
 *
 */
public class Verifier
{
    private final String filename;  // name, with full path, of the jar to verify
    ...
    public static void main(String[] args) {
        Verifier signer = new Verifier(args[0]);
        try {
            signer.verify();
        } catch (Exception e) {
            System.exit(1);
